...
<html>
    ...
    <body>
        ...
        <div id="show-participant" class="content scaffold-show" role="main">
            ...
            <f:display bean="participant" />
            <g:form resource="${this.participant}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.participant}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
