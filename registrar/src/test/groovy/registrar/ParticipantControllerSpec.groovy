...
class ParticipantControllerSpec extends Specification implements ControllerUnitTest<ParticipantController>, DomainUnitTest<Participant> {

    def populateValidParams(params) {
        assert params != null

        params["name"] = 'Doe the ' + Math.random()
        params["firstName"] = 'John'
        params["telephoneContact"] = '+440123456789'
        params["emailContact"] = 'john.doe@example.org'
    }
